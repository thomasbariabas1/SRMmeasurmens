 ...
 */
public class SafetyInfoMap extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.safetysearchmap, container, false);
    ...
    private void setUpMapIfNeeded() {
        ...
        if (mMap == null) {
            ...
            mMap = ((SupportMapFragment) this.getChildFragmentManager().findFragmentById(R.id.safetymap)).getMap();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (mMap == null) {
            ...
            mMap = ((SupportMapFragment) SpectrumInfo.fragmentManager
                    .findFragmentById(R.id.safetymap)).getMap(); // getMap is deprecated
            // Check if we were successful in obtaining the map.
            if (mMap != null)
                setUpMap();
        }
